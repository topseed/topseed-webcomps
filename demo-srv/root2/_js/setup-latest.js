...
loadjs([ // should be in cache manifest 
	'https://cdn.rawgit.com/topseed/topseed-turbo/master/vendor/flyd.min.js'
		...
		loadjs([// these should be in cache manifest 
			...
			,'https://unpkg.com/topseed-util@24.0.0/PLX.js' // key part for comp com

			//,'https://rawgit.com/topseed/topseed-turbo/master/webComps/tw-2.0.js'// could be optional, loaded from main.
			, '/_js/tw-2.1.js' 

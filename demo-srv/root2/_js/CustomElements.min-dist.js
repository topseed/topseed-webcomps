...
"undefined" == typeof WeakMap && function() {
        ...
        a.prototype = {
            observe: function(e, t) {
                ...
                for (var r, i = 0; i < o.length; i++) if (o[i].observer === this) {
                    (r = o[i]).removeListeners(), r.options = t;
                    break;
                }
            ...
            handleEvent: function(e) {
                switch (e.stopImmediatePropagation(), e.type) {
                  case "DOMAttrModified":
                    ...
                    (r = new u("attributes", o)).attributeName = t, r.attributeNamespace = n;
                    a = e.attrChange === MutationEvent.ADDITION ? null : e.prevValue;
                    i(o, function(e) {
                        if (e.attributes && (!e.attributeFilter || !e.attributeFilter.length || -1 !== e.attributeFilter.indexOf(t) || -1 !== e.attributeFilter.indexOf(n))) return e.attributeOldValue ? c(a) : r;
                    });
                    break;

                  case "DOMCharacterDataModified":
                    var r = u("characterData", o = e.target), a = e.prevValue;
                    i(o, function(e) {
                  ...
                  case "DOMNodeInserted":
                    ...
                    var p = f.previousSibling, w = f.nextSibling;
                    (r = u("childList", e.target.parentNode)).addedNodes = d, r.removedNodes = s, r.previousSibling = p, 
                    r.nextSibling = w, i(e.relatedNode, function(e) {
    ...
    e.addModule = o, e.initializeModules = r, e.hasNative = Boolean(document.registerElement), 
    e.isIE = /Trident/.test(navigator.userAgent), e.useNative = !t.register && e.hasNative && !window.ShadowDOMPolyfill && (!window.HTMLImports || window.HTMLImports.useNative);
    ...
    function n(e, t, o) {
        ...
        for (;r; ) !0 !== t(r, o) && n(r, t, o), r = r.nextElementSibling;
        return null;
    }
    function o(e, n) {
    ...
    function v(e) {
        ...
        t(e, e === window.wrap(document)), m(e), g.dom && console.groupEnd();
    }
    function h(e) {
        E(e, v);
    }
    ...
    }), e.watchShadow = f, e.upgradeDocumentTree = h, e.upgradeDocument = v, e.upgradeSubtree = o, 
    e.upgradeAll = t, e.attached = a, e.takeRecords = w;
}), window.CustomElements.addModule(function(e) {
    function t(t, o) {
        if ("template" === t.localName && window.HTMLTemplateElement && HTMLTemplateElement.decorate && HTMLTemplateElement.decorate(t), 
    ...
    function n(t, n, r) {
        ...
        o(t, n), t.__upgraded__ = !0, i(t), r && e.attached(t), e.upgradeSubtree(t, r), 
        a.upgrade && console.groupEnd(), t;
    }
    function o(e, t) {
    ...
    function r(e, t, n) {
        for (var o = {}, r = t; r !== n && r !== HTMLElement.prototype; ) {
            for (var i, a = Object.getOwnPropertyNames(r), d = 0; i = a[d]; d++) o[i] || (Object.defineProperty(e, i, Object.getOwnPropertyDescriptor(r, i)), 
            o[i] = 1);
    ...
    function t(t, o) {
        ...
        return s.prototype || (s.prototype = Object.create(HTMLElement.prototype)), s.__name = t.toLowerCase(), 
        s.extends && (s.extends = s.extends.toLowerCase()), s.lifecycle = s.lifecycle || {}, 
        s.ancestry = i(s.extends), a(s), d(s), n(s.prototype), c(s.__name, s), s.ctor = l(s), 
        s.ctor.prototype = s.prototype, s.prototype.constructor = s.ctor, e.ready && v(document), 
        s.ctor;
    }
    function n(e) {
    ...
    function d(e) {
        if (!Object.__proto__) {
            ...
            for (var o, r = e.prototype, i = !1; r; ) r == t && (i = !0), (o = Object.getPrototypeOf(r)) && (r.__proto__ = o), 
            r = o;
            i || console.warn(e.tag + " prototype not found in prototype chain for " + e.is), 
            e.native = t;
        }
    }
    function s(e) {
    ...
    function p(e, t) {
        ...
        var o;
        return t ? ((o = p(e)).setAttribute("is", t), o) : (o = M(e), e.indexOf("-") >= 0 && b(o, HTMLElement), 
        o);
    }
    function w(e, t) {
        var n = e[t];
    ...
    m = Object.__proto__ || E ? function(e, t) {
        ...
        return !1;
    }, w(Node.prototype, "cloneNode"), w(document, "importNode"), document.registerElement = t, 
    document.createElement = p, document.createElementNS = f, e.registry = y, e.instanceof = m, 
    e.reservedTagList = _, e.getRegisteredDefinition = u, document.register = document.registerElement;
}), function(e) {
    function t() {
